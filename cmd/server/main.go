...
func main() {
	...
	commandMode := vertexImport != "" || antigravityLogin || codexLogin || codexDeviceLogin || claudeLogin || kimiLogin || kimiAILogin || xaiLogin || codebuddyCnLogin || codebuddyIntlLogin || dimagentLogin || qoderLogin || devinLogin || metaLogin
